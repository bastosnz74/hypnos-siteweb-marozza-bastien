                            ...
                            <div class="boking_table">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="book_tabel_item">
                                            <div class="input-group">
                                               <input type="text" name="txtEmail" placeholder="Enter your email" class="form-control" required>  
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="book_tabel_item">
                                        <div class="input-group">
                                            <input type="password" name="txtPassword" placeholder="Enter your password" class="form-control" required> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
